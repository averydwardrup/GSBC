...
if ( current_user_can( 'edit_theme_options' ) ) {
	...
	$entry               = get_theme_mod( 'illdy_jumbotron_general_entry', __( '1 TIMOTHY 3:15 “… the house of God, which is the church of the living God, the pillar and ground of the truth.”', 'illdy' ) );
